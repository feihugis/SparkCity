/**
 * FILE: GeoSparkVizImageGenerator.java
 * PATH: org.datasyslab.geosparkviz.extension.imageGenerator.GeoSparkVizImageGenerator.java
...
/**
 * The Class GeoSparkVizImageGenerator.
 */
public class GeoSparkVizImageGenerator {


	/** The Constant logger. */
	final static Logger logger = Logger.getLogger(GeoSparkVizImageGenerator.class);
